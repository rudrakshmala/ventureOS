// 📄 src/mastra/agents/pathNormalizer.ts
import { Agent } from '@mastra/core/agent';

export const pathNormalizerAgent = new Agent({
  name: 'pathNormalizerAgent',
  id: 'pathNormalizerAgent',
  instructions: `
    You are the pathNormalizer for the VentureOS 76-Agent Empire.
